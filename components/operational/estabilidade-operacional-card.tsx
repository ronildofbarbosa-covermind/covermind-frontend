...
export function EstabilidadeOperacionalCard({
  score,
  status,
  descricao,
}: Props) {
      ...
      <div className="mb-3 flex items-center justify-between">
        <div>
          <h3 className="text-xl font-bold">
            Estabilidade Operacional IA
          </h3>

          <p className="mt-1 text-xs text-slate-400">
            Sustentação e equilíbrio operacional
          </p>
        </div>
