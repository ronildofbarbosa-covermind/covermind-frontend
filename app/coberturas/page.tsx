...
export default function CoberturasPage() {
  ...
  const ocorrenciasOperacionais: OcorrenciaOperacional[] = [
  {
    ...
    matriculaColaborador: "54879",
    nomeColaborador: "Ana Souza",
    cargoColaborador: "Recepcionista",
    criticidadePosto: "ALTA",
    impactoCliente: "Atendimento principal comprometido",
    impactoSla: "ALTO",
    riscoContratual: "ALTO",
    nivelImpacto: "ALTO",
    iccContrato: 87,
    classificacaoContrato: "VIP",
    elegiveis: 9,
    filaAtiva: 5,
    recusas: 2,
    topScore: 175,
  },
  {
    ...
    grupoOcorrencia: "Ausência do Colaborador",
    possuiOcupanteVinculado: true,
    matriculaColaborador: "77412",
    nomeColaborador: "Carlos Lima",
    cargoColaborador: "Vigilante",
    criticidadePosto: "CRITICA",
    impactoCliente: "Posto patrimonial sensível em substituição temporária",
    impactoSla: "MEDIO",
    riscoContratual: "MEDIO",
    nivelImpacto: "MEDIO",
    iccContrato: 72,
    classificacaoContrato: "PREMIUM",
    elegiveis: 7,
    filaAtiva: 4,
    recusas: 1,
    topScore: 115,
  },
  {
    ...
    impactoCliente: "Controle de acesso com risco de descontinuidade",
    impactoSla: "MEDIO",
  ...
  },
  {
    ...
    possuiOcupanteVinculado: false,
    criticidadePosto: "BAIXA",
    impactoCliente: "Capacitação preventiva sem descontinuidade direta",
    impactoSla: "BAIXO",
    riscoContratual: "NENHUM",
    nivelImpacto: "BAIXO",
    iccContrato: 35,
    classificacaoContrato: "PADRAO",
    elegiveis: 8,
